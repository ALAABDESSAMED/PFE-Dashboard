...
$(function () {
  ...
  var dt_category_list_table = $('.datatables-category-list'),
      dt_variants_list = $('.datatables-variants-list');
       ...
       
        {
          ...
          render: function (data, type, full, meta) {
            return (
              ...
              '<button class="btn btn-sm btn-icon" data-bs-toggle="offcanvas" data-bs-target="#offcanvasEcommerceCategoryEdit"><i class="ti ti-edit"></i></button>' +
              '</div>'
            );
          }
        }
  ...
  if (dt_variants_list.length) {
    var dt_category = dt_variants_list.DataTable({
      ajax: assetsPath + 'json/ecommerce-variants-list.json', // JSON file to add data
      columns: [
        // columns according to JSON
        { data: '' },
        { data: 'id' },
       ...
       
        {
          ...
          render: function (data, type, full, meta) {
            return (
              '<div class="d-flex align-items-sm-center justify-content-sm-center">' +
              '<button class="btn btn-sm btn-icon delete-record me-2"><i class="ti ti-trash"></i></button>' +
              '<button class="btn btn-sm btn-icon" data-bs-toggle="offcanvas" data-bs-target="#offcanvasEcommerceVariantsEdit"><i class="ti ti-edit"></i></button>' +
              '</div>'
            );
          }
        }
      ...
      buttons: [
        {
          text: '<i class="ti ti-plus ti-xs me-0 me-sm-2"></i><span class="d-none d-sm-inline-block">Ajouter Variante</span>',
          className: 'add-new btn btn-primary ms-2',
          attr: {
            'data-bs-toggle': 'offcanvas',
            'data-bs-target': '#offcanvasEcommerceVariantsList'
          }
        }
      ],
      // For responsive popup
  ...
  // Delete Record
  $('.datatables-variants-list tbody').on('click', '.delete-record', function () {
